...
.site-footer .fcol{flex:0 0 78%;max-width:78%}
.site-footer h4{font-family:'DM Sans',sans-serif;color:#fff;font-size:18px;margin:0 0 10px;font-weight:500}
.site-footer p{color:#bcbcbc;font-size:16px;margin:0 0 26px;line-height:1.4}
.site-footer a{color:#bcbcbc;text-decoration:none}
.site-footer a:hover{color:var(--gold)}
.site-footer .fnav{display:flex;flex-direction:column;gap:13px;flex:0 0 22%}
