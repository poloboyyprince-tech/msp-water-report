...
.topbar .logo{width:80px;height:107px;display:block}
...
.site-footer .fwrap{max-width:1170px;margin:0 auto;display:flex;gap:0;flex-wrap:wrap}
.site-footer .fcol{flex:0 0 78.7%;max-width:78.7%}
...
.site-footer .fnav{display:flex;flex-direction:column;gap:14px;flex:0 0 21.3%}
.site-footer .fnav a{font-family:'DM Sans',sans-serif;color:#fff;font-size:16px}
.site-footer .fdiv{max-width:1170px;margin:34px auto;border-top:1px solid rgba(255,255,255,.16)}
