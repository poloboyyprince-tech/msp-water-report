...
a{color:var(--navy)}
.topbar{background:#fff;color:var(--navy);padding:10px 24px;border-bottom:1px solid var(--line)}
.topbar .wrap{max-width:1100px;margin:0 auto;display:flex;align-items:center;gap:26px}
...
.topbar .nav a{font-family:'Montserrat',sans-serif;color:var(--navy);text-decoration:none;font-size:15px;font-weight:500}
.topbar .nav a:hover{color:var(--gold)}
.topbar .callbox{text-align:right;text-decoration:none;line-height:1.2}
.topbar .callbox .ct{display:block;color:var(--gold);font-family:'Montserrat',sans-serif;font-weight:700;font-size:13.5px}
.topbar .callbox .cn{display:block;color:var(--navy);font-family:'Montserrat',sans-serif;font-weight:700;font-size:16px}
...
.site-footer{background:var(--navy);color:#fff;padding:46px 24px 26px;margin-top:46px}
.site-footer .fwrap{max-width:1100px;margin:0 auto;display:flex;justify-content:space-between;gap:40px;flex-wrap:wrap}
.site-footer h4{font-family:'Montserrat',sans-serif;color:#fff;font-size:15px;margin:0 0 7px;font-weight:700}
.site-footer p{color:#aab6cc;font-size:14px;margin:0 0 20px;line-height:1.7}
.site-footer a{color:#aab6cc;text-decoration:none}
.site-footer a:hover{color:var(--gold)}
.site-footer .fnav{display:flex;flex-direction:column;gap:11px}
.site-footer .fnav a{font-family:'Montserrat',sans-serif;color:#fff;font-size:14px}
.site-footer .fdiv{max-width:1100px;margin:26px auto;border-top:1px solid rgba(255,255,255,.14)}
.site-footer .fbottom{max-width:1100px;margin:0 auto;display:flex;justify-content:space-between;gap:16px;flex-wrap:wrap;color:#8a97ad;font-size:12.5px}
...
<a class="callbox" href="tel:{PHONE_DIGITS}"><span class="ct">&#128222; Call or Text Today</span><span class="cn">{esc(PHONE_FMT)}</span></a>
</div></header>
<main>{body}</main>
<footer class="site-footer">
<div class="fwrap">
<div class="fcol"><h4>Service Area</h4><p>The Twin Cities &amp; Greater Minnesota</p>
...
<span class="flinks"><a href="{SITE}/privacy-policy">Privacy Policy</a> &nbsp;&middot;&nbsp; <a href="{SITE}/tos">Terms of Use</a></span></div>
</footer>
</body></html>"""
