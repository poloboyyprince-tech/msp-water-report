...
a{color:var(--navy)}
.topbar{background:#fff;color:var(--navy);padding:14px 40px;border-bottom:none}
.topbar .wrap{max-width:1200px;margin:0 auto;display:flex;align-items:center;gap:30px}
...
.topbar .nav a{font-family:'DM Sans',sans-serif;color:var(--navy);text-decoration:none;font-size:21px;font-weight:500}
.topbar .nav a:hover{color:var(--gold)}
.topbar .callbox{text-align:center;text-decoration:none;line-height:1.35}
...
.site-footer{background:var(--navy);color:#fff;padding:60px 40px 30px;margin-top:50px}
.site-footer .fwrap{max-width:1200px;margin:0 auto;display:flex;justify-content:space-between;gap:40px;flex-wrap:wrap}
...
.site-footer .fnav{display:flex;flex-direction:column;gap:13px}
.site-footer .fnav a{font-family:'DM Sans',sans-serif;color:#fff;font-size:17px}
.site-footer .fdiv{max-width:1200px;margin:30px auto;border-top:1px solid rgba(255,255,255,.16)}
.site-footer .fbottom{max-width:1200px;margin:0 auto;display:flex;justify-content:space-between;gap:16px;flex-wrap:wrap;color:#8a97ad;font-size:14px}
