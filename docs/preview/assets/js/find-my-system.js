  ...
  function build(root) {
    ...
    function contactHtml() {
      return '<div class="fields-2">' + field("first_name", "First name", "text", 'autocomplete="given-name"', true) + field("last_name", "Last name", "text", 'autocomplete="family-name"', true) + "</div>" +
        ...
        esc(consent.text || "") + ' <a href="/preview/privacy/" class="link">Privacy Policy</a></div>';
    }
    ...
    function submit() {
      ...
      window.MSPCRM.submitLead(state.data).then(function (res) {
        if (res.ok) {
          ...
          location.assign("/preview/thank-you/");
          return;
        }
        state.submitting = false; btn.removeAttribute("aria-disabled"); btn.textContent = "Try again";
        if (res.error === "not_configured") {
          status.innerHTML = "Online intake isn’t live yet. Call or text <a href=\"tel:+19529526206\"><b>(952) 952-6206</b></a> and we’ll take it from here, or <a href=\"/preview/schedule/\" class=\"link\">pick a time online</a>.";
