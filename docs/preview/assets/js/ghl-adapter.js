...
(function () {
  ...
  function fallback(el, kind) {
    ...
    el.innerHTML = '<div class="ghl-fallback"><h3>' + title + '</h3><p>' + body + '</p>' +
      ...
      (kind === "contact" ? '<a class="btn btn-navy" href="mailto:info@msppurewaterco.com">Email info@msppurewaterco.com</a>' : kind === "call" ? '<a class="btn btn-navy" href="sms:' + tel + '">Text us</a>' : '<a class="btn btn-navy" href="/preview/schedule/">Schedule page</a>') + '</div>';
  }
